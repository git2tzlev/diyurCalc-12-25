# ארכיון שינויים היסטורי - DiyurCalc

קובץ זה נשמר כארכיון תיעוד פנימי ישן.

חשוב:

- מקור האמת הפעיל לשינויים שוטפים הוא `CHANGELOG.md` בשורש הפרויקט
- מספור הגרסאות בקובץ זה הוא היסטורי ואינו משמש כגרסת היישום הנוכחית
- אין להסתמך על קובץ זה לבדו לצורך הבנת מצב הקוד הנוכחי
