...
BERESHIT_APT_TYPE = 3       # בראשית
KALANIYOT_APT_TYPE = 5      # כלניות
...
SPECIAL_ABSENCE_PAYMENT_APT_TYPES = {BERESHIT_APT_TYPE, KALANIYOT_APT_TYPE}
...
APT_TYPE_NAMES = {
    ...
    BERESHIT_APT_TYPE: "בראשית",
    KALANIYOT_APT_TYPE: "כלניות",
...
# =============================================================================
# Payment Component Type IDs
# =============================================================================

SUBSTITUTE_TRAVEL_TYPE_ID = 7   # נסיעות מדריך מחליף
