...
BUSINESS_RULE_SECTIONS: tuple[BusinessRuleSection, ...] = (
    ...
    BusinessRuleSection(
        ...
        rules=(
            BusinessRule(
                title="זכאות בסיסית",
                summary="דמי הבראה משולמים למדריכים פעילים בלבד עם ותק של שנה ומעלה.",
                details=(
                    "הכלל חל גם על מדריכים שאינם קבועים, אם הם פעילים ועברו שנת ותק.",
                    ...
                    "מדריכים שעזבו אינם מחושבים במסלול השנתי, כי התשלום עבורם מטופל ידנית בעת העזיבה.",
